...
const PROCESS_ITEMS = [
  ...
  },
  {
    ...
    metaLabel: "Lead Management",
    desc: "Store all lead and deal data in one searchable platform—no more scattered spreadsheets or lost information.",
  },
];
          ...
          <div className="row pb-50 align-items-end">
            ...
            <div className="col-xxl-5 col-lg-8 text-lg-end ms-auto">
              <h6 className="fw-600 fz-font-lg">
                Manage leads and deals seamlessly with a unified pipeline that
                boosts conversions, accelerates sales cycles, and drives
                consistent growth.
              </h6>
            </div>
          </div>
