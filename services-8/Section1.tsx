          ...
          <div className="container">
            <div className="row align-items-center p-relative">
              <div className="col-xxl-5 col-lg-6 pt-lg-0 pt-100">
                <span className="at-btn common-black bg-transparent mb-10 rounded-0 p-0">
                  <span className="text-uppercase">
                    <span className="text-1">Meetings & Chats</span>
                    <span className="text-2">Meetings & Chats</span>
                  </span>
                  <i>
                    {ARROW_SVG}
                    {ARROW_SVG}
                ...
                <div className="col-lg-8">
                  <h6 className="fw-500 fz-font-lg reveal-text mb-0">
                    <RevealText>
                      We bring your meetings and chats into one seamless
                      platform that keeps conversations organized, improves
              ...
              >
                <div data-speed=".8">
                  <Image
                    src="/assets/Image/MeetingsChats.avif"
                    alt="orisa"
                    width={1900}
                    height={800}
                    style={{
