          ...
          <div className="at-offcanvas">
            ...
            <div className="at-offcanvas-content d-none d-xl-block">
              ...
              <p className="fz-font-lg">
                We blend strategy, creativity, and technology to help brands
                grow, connect, and stand out in an ever-evolving digital world.
              </p>
            </div>
            ...
            <div className="at-offcanvas-contact">
              ...
              <ul>
                <li>
                  <a className="fz-font-lg" href="tel:+971-585901002">
                    +971-585901002
                  </a>
                </li>
                <li>
                  <a className="fz-font-lg" href="mailto:info@rispercrm.com">
                    info@rispercrm.com
                  </a>
                </li>
                <li>
