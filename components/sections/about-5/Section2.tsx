          ...
          <div className="row pb-50 align-items-end">
            ...
            <div className="col-xxl-5 col-lg-8 text-lg-end ms-auto">
              <h6 className="fw-600 fz-font-lg">
                We simplify internal operations with a centralized employee
                portal for managing tasks, tracking performance, handling
                documents, and streamlining daily workflows—all in one place.
              </h6>
            </div>
          </div>
        </div>
