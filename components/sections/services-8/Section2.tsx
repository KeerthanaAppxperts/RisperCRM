          ...
          <div className="row g-3">
            ...
            <div className="col-lg-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage: "url(/assets/images/Image11.jpg)",
                }}
                data-background="/assets/images/Image11.jpg"
              >
                <Link
                  href="#"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Unified Smart Calendar</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Sync Zoom meetings → Auto-block overlapping slots
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  ...
                  <h6 className="mt-3">
                    <Link href="#">1-Click Zoom Meetings</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Launch or schedule Zoom calls → Auto-generate links +
                      calendar invites.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">In Built Encrypted Chat</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Secure-ready messaging for staff/clients. keep the
                      official Chat more safe
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div
                className="at-service-card card-1 rounded-4 overflow-hidden p-relative bg-cover"
                style={{
                  backgroundImage: "url(/assets/images/Key7.jpeg)",
                }}
                data-background="/assets/images/Key7.jpeg"
              >
                <Link
                  href="#"
                  className="p-absolute top-0 left-0 w-100 h-100"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_1}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Secure Document Collaboration</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Share sensitive files within chats → View-only mode,
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                <Link href="#" className="p-absolute bottom-0 start-0 end-0">
                  <Image
                    className="img-cover"
                    src="/assets/images/Require1.jpeg"
                    alt="orisa"
                    width={400}
                    height={500}
                  />
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">Auto-Reminders &amp; Follow-ups</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Push alerts for meetings → "10 mins until Zoom call with
                      Acme Co!"
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Granular Access Controls</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Lock chats/meetings by role → Clients see only their
                      projects, staff see team calendars.
                    </p>
                  </div>
                </div>
              </div>
