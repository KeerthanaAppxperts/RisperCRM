          ...
          <div className="row g-3">
            ...
            <div className="col-lg-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage: "url(/assets/images/Image9.jpg)",
                }}
                data-background="/assets/images/Image9.jpg"
              >
                <Link
                  href="#"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Clock In/Out + Biometrics</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Staff log time via app, web, or biometric devices →
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  ...
                  <h6 className="mt-3">
                    <Link href="#">Tasks &amp; Projects Dashboard</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      View assigned tasks, Gantt charts & deadlines – know
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-black p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-black mt-3">
                    <Link href="#">Leave &amp; Shift Management</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-black">
                      Request time off, swap shifts, or view rosters →
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_1}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Payroll &amp; Payslip Access</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      View payslips, tax docs, and bonuses – no more HR
                      back-and-forth.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">Staff Appreciation Wall</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Public shout-outs, awards, and milestones → Boost team
                      morale instantly.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Expense Claims Made Easy</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Snap receipt photos → Submit expenses → Auto-syncs to
                      payroll/accounting.
                    </p>
                  </div>
                </div>
