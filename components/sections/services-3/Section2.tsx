          ...
          <div className="row g-3">
            ...
            <div className="col-lg-4 col-md-6">
              <div
                ...
                style={{
                  backgroundImage: "url(/assets/images/Image13.jpg)",
                }}
                data-background="/assets/images/Image13.jpg"
              >
                <Link
                  href="#"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Professional Proposals Fast</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Create, send, and track proposals in seconds. Clients
              ...
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                <Link href="#" className="p-absolute bottom-0 start-0 end-0">
                  <Image
                    ...
                    alt="orisa"
                    width={400}
                    height={300} // reduce here (optional)
                    className="img-cover reduced-img"
                  />
                </Link>
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">Instant Invoices &amp; Payments</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Generate invoices automatically. Add payment links
                      (Stripe/PayPal) for 1-click payments.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Smart Contract Hub</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Store, sign, and renew contracts. Get auto-reminders for
                      expiring terms.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div
                className="at-service-card card-1 rounded-4 overflow-hidden p-relative bg-cover"
                style={{
                  backgroundImage: "url(/assets/images/Image17.jpg)",
                }}
                data-background="/assets/images/Image17.jpg"
              >
                <Link
                  href="#"
                  className="p-absolute top-0 left-0 w-100 h-100"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_1}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Real-Time Financial Reports</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      See profit/loss, tax summaries, and sales trends in live
                      dashboards.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">Expense &amp; Credit Note Tracking</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Log receipts, issue credit notes, and track costs → No
                      more shoeboxes of receipts!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">QuickBooks Sync</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Auto-sync invoices, expenses, and payments → Zero manual
                      data entry.
                    </p>
                  </div>
                </div>
