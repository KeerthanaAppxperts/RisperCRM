          ...
          <div className="row g-3">
            ...
            <div className="col-lg-4 col-md-6">
              <div
                ...
                data-background="/assets/images/Image1.jpg"
              >
                <Link
                  href="#"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">All Documents in One Place</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Clients view proposals, invoices, contracts & expenses –
                      searchable, downloadable, 24/7.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  ...
                  <h6 className="mt-3">
                    <Link href="#">Live Project Dashboards </Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      See tasks, timelines & Gantt charts – know exactly where
                      their project stands.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Real-Time Approvals &amp; Feedback</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Comment on proposals, approve quotes, or flag issues – no
                      emails needed!
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_1}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Gantt Chart Visualizer</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Drag-and-drop timelines show progress, delays, and
                      milestones – crystal clear.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">Built-in Support Tickets</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Submit issues → Auto-assigns to your team → Track fixes in
                      real time.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Secure File Exchange</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Upload/download contracts, designs, or reports –
