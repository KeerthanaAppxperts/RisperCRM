          ...
          <div className="row g-3">
            ...
            <div className="col-lg-4 col-md-6">
              <div
                ...
                data-background="/assets/images/Image5.jpg"
              >
                <Link
                  href="#"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Projects with Clear Statuses</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      See every project’s stage: To Do → Upcoming → In Progress
                      → Completed. Example: “Website Redesign: In Progress (65%
                      Done)”
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  ...
                  <h6 className="mt-3">
                    <Link href="#">Break Projects into Tasks</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Split big projects into small tasks (e.g., “Buy domain,”
                      “Design homepage”). Add start/end dates to each task No
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Live Progress Dashboard</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Owners/managers see all tasks in real time: → Who’s
                      working on what? → What’s late? What’s done?
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div
                className="at-service-card card-1 rounded-4 overflow-hidden p-relative bg-cover"
                style={{
                  backgroundImage: "url(/assets/images/Key8.jpeg)",
                }}
                data-background="/assets/images/Key8.jpeg"
              >
                <Link
                  href="#"
                  className="p-absolute top-0 left-0 w-100 h-100"
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_1}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Drag-and-Drop Kanban Board</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Visually organize tasks → Drag tasks between columns
                      (e.g., “To Do” → “Done”). Feels like moving sticky notes
                      on a wall!
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">1-Click Task Assignments</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      Assign tasks to staff in one click → They get instant
                      alerts. “Maria: Design client brochure by Friday”
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Automatic Overdue Alerts</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Get notifications for late tasks → Fix bottlenecks fast.
                      “Task #42: ‘Call supplier’ is 2 days overdue!”
                    </p>
                  </div>
                </div>
              </div>
