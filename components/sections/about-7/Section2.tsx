          ...
          <div className="row pb-50 align-items-end">
            ...
            <div className="col-xxl-5 col-lg-8 text-lg-end ms-auto">
              <h6 className="fw-600 fz-font-lg">
                Manage projects and tasks seamlessly with a unified system that
                improves collaboration, tracks progress, and ensures on-time
                delivery.
              </h6>
            </div>
          </div>
