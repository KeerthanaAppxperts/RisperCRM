              ...
              >
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Fair Lead Sharing &amp; Tracking</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      New leads (from forms, calls, etc.) automatically shared
                      equally among your team. Track lead status easily: New,
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  ...
                  <h6 className="mt-3">
                    <Link href="#">Deal Progress Board - Real Time</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      See every deal’s stage at a glance: → Follow-up → Proposal
                      Sent → Discussion → Won/Lost. Drag and drop deals to
                      update their stage – like moving sticky notes!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  ...
                  <h6 className="text-white mt-3">
                    <Link href="#">Never Forget a Follow-Up</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Set reminders for calls, emails, or meetings. Example:
                      “Remind Sarah to call John about Proposal #101 tomorrow at
                      10 AM.”
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              ...
              >
                ...
                <div className="at-service-card-content text-white p-absolute bottom-0 start-0 end-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_1}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">Send Proposals in Seconds</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="text-white mb-0">
                      Create professional proposals with 1 click with Sharable
                      Link & email Automation. See when clients open them and
                      add comments.
                    </p>
                  </div>
                </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-2 rounded-4 overflow-hidden p-relative bg-neutral-50">
                ...
                <div className="at-service-card-content p-absolute top-0 left-0 m-xxl-5 m-4">
                  <div className="at-service-card-icon">{ICON_2}</div>
                  <h6 className="mt-3">
                    <Link href="#">Complete Lead History</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0">
                      View every interaction: calls, emails, notes. Know exactly
                      “who talked to the lead last?” and “what was said?”
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="at-service-card card-3 rounded-4 overflow-hidden p-relative">
                ...
                <div className="at-service-card-content text-white p-absolute top-50 left-0 mx-xxl-5 mx-4 translate-middle-y">
                  <div className="at-service-card-icon">{ICON_3}</div>
                  <h6 className="text-white mt-3">
                    <Link href="#">1-Click Client Setup</Link>
                  </h6>
                  <div className="at-service-card-description">
                    <p className="mb-0 text-white">
                      Click “Won” → Auto-send invoices + create a client login
                      portal. Lost a deal? Mark why (e.g., “too expensive”) to
                      improve next time.
                    </p>
                  </div>
                </div>
