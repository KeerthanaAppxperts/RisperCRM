          ...
          <div className="container">
            <div className="row align-items-center p-relative">
              <div className="col-xxl-5 col-lg-6 pt-lg-0 pt-100">
                <span className="at-btn common-black bg-transparent mb-10 rounded-0 p-0">
                  <span className="text-uppercase">
                    <span className="text-1">Sales and Accounts</span>
                    <span className="text-2">Sales and Accounts</span>
                  </span>
                  <i>
                    {ARROW_SVG}
                    {ARROW_SVG}
                ...
                <div className="col-lg-8">
                  <h6 className="fw-500 fz-font-lg reveal-text mb-0">
                    <RevealText>
                      We transform your sales and accounting workflows into a
                      seamless system that boosts conversions, speeds up
                      payments, and drives sustainable growth.
                    </RevealText>
                  </h6>
                </div>
              </div>
              ...
              >
                <div data-speed=".8">
                  <Image
                    src="/assets/Image/SalesAccounts.avif"
                    alt="orisa"
                    width={1900}
                    height={800}
                    style={{
